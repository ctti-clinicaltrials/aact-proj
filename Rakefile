...
namespace :db do
  ...
  def reset_search_path
    ...
    con.execute("ALTER ROLE #{ENV['AACT_PROJ_DB_SUPER_USERNAME']} IN DATABASE  #{ENV['AACT_PROJ_DATABASE']} SET search_path TO proj, proj_anderson, proj_tag, proj_tag_nephrology, ctgov;")
    con.reset!
  end
