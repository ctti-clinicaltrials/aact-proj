module ProjTagOncology
  class AnalyzedStudy < ActiveRecord::Base
    self.table_name = 'proj_tag_oncology.analyzed_studies'

    def self.populate
      file_name = ProjTagOncology::ProjectInfo.datasets.select{|ds| ds[:table_name] == 'analyzed_studies'}.first[:file_name]
