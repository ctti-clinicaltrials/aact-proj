module ProjTagOsteoporosis
  class AnalyzedStudy < ActiveRecord::Base
    self.table_name = 'proj_tag_osteoporosis.analyzed_studies'

    def self.populate
      file_name = ProjTagOsteoporosis::ProjectInfo.datasets.select{|ds| ds[:table_name] == 'analyzed_studies'}.first[:file_name]
