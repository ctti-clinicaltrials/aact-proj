module ProjTagPulmonary
  class AnalyzedStudy < ActiveRecord::Base
    self.table_name = 'proj_tag_pulmonary.analyzed_studies'

    def self.populate
      file_name = ProjTagPulmonary::ProjectInfo.datasets.select{|ds| ds[:table_name] == 'analyzed_studies'}.first[:file_name]
