...
<p>The organization information curated for the CDEK project is now available in AACT.  Organizations are often identified by a variety of names in ClinicalTrials.gov, making it difficult to identify all studies associated with an organization. For example, 'Weill Cornell Medicine' and 'Weill Medical College of Cornell University' are both considered 'Cornell University'. In fact, Cornell University, its schools and institutes, are represented 75 different ways in ClinicalTrials.gov.</p>

<p>The organizations curated for the CDEK project are now available in AACT.  Organizations are often identified with a variety of names in ClinicalTrials.gov, making it difficult to identify all studies associated with an organization. For example, 'Weill Cornell Medicine' and 'Weill Medical College of Cornell University' are both considered 'Cornell University'. In fact, Cornell University, its schools and institutes, are represented 75 different ways in ClinicalTrials.gov.</p>

<p>Note: The cdek_organizations table essentially contains a unique list of the 'names' that appear as 'preferred_names' in the cdek_synonyms table.</p>",
     }
    end
