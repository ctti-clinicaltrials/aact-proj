module ProjTagCardiology
  class AnalyzedStudy < ActiveRecord::Base
    self.table_name = 'proj_tag_cardiology.analyzed_studies'

    def self.populate
      file_name = ProjTagCardiology::ProjectInfo.datasets.select{|ds| ds[:table_name] == 'analyzed_studies'}.first[:file_name]
